...
def spider(PATH,part=0,cs={}):
    ...
    for i in titles:
        ...
        if(part == 0):
            ...
            cs[sn] = ([text, "碩士在職專班"])
    return cs
cs=spider("https://course.thu.edu.tw/view-dept/{}/{}/350".format(year, semester))
cs=spider("https://course.thu.edu.tw/view-dept/{}/{}/357".format(year, semester),1,cs)
...
for i in range(len(a)):
    ...
    if i!=0:
        ...
        new_doc=docx.Document("../word_output/{}教學成效表.docx".format(year+sys.argv[3]))
